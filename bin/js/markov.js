...
var _$Main_CustomQueryStringOption = $hxEnums["_Main.CustomQueryStringOption"] = { __ename__ : true, __constructs__ : ["EVERYTHING","NO_TRAINING_DATA"]
	,EVERYTHING: {_hx_index:0,__enum__:"_Main.CustomQueryStringOption"}
	,NO_TRAINING_DATA: {_hx_index:1,__enum__:"_Main.CustomQueryStringOption"}
};
var Main = function() {
	this.lastNames = [];
...
TrainingDatas["Supermarkets And Discount Stores"] = ["aldi","asda","bargainbooze","bargainbuys","bargaincrazy","bimart","booths","bottomdollarfood","budgens","burlington ","buyright","cooltrader","cornerstore","costco","costcutter","cubfoods","deals","dollargeneral","dollartree","drugfair","familybargains","familymart","farmfoods","farmfreshexpress","fedmart","foodmart","gemco","gordmans","grandcentral","happyshopper","hartsstores","homebargains","hypervalue","iceland","jamesway","kaufland","kmart","kwiksave","kwiktrip","magicmart","mammothmart","morrisons","nationalstores","netto","ocado","poundland","poundstretcher","poundworld","premierstores","premiersupermarkets","richway","rodgersstores","rossstores","sainsburys","savealot","saverite","savershealth","seveneleven","shopko","shoppercity","shoprite","shopritehyper","steinmart","tesco","valumart","venturestores","waitrose","walmart","wellworths","whitemart","wincofoods","woolco","woolworths"];
