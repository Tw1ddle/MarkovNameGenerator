...
Main.prototype = {
	...
	,setNames: function(names) {
		...
		while(_g1 < names.length) {
			...
			if(!(name != null)) throw new js__$Boot_HaxeError("FAIL: str != null");
...
markov_namegen_Generator.prototype = {
	...
	,getLetter: function(context) {
		...
		if(!(context.length > 0)) throw new js__$Boot_HaxeError("FAIL: context.length > 0");
		var letter = null;
...
markov_util_StringExtensions.reverse = function(str) {
	if(!(str != null)) throw new js__$Boot_HaxeError("FAIL: str != null");
	var arr = str.split("");
	arr.reverse();
	return arr.join("");
};
